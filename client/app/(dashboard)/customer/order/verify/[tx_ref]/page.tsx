			...
			<div
				...
				{data?.status === 'successful' && (
					<div className="flex flex-col justify-center items-center">
						...
						<p className="my-2 text-gray-600">Your payment of {data?.amount} was successful.</p>
				...
				{data?.status === 'failed' && (
					<div className="flex flex-col justify-center items-center">
						...
						<p className="my-2 text-gray-600">Your payment of {data?.amount} failed.</p>
						<p className="my-2 text-gray-600">Please wait a moment, we will redirect you shortly.</p>
						<Loader />
					</div>
				)}
				{data?.status === 'pending' && (
					<div id={data?._id} className="flex flex-col justify-center items-center">
						...
						<p className="my-2 text-gray-600">Your payment of {data?.amount} is pending.</p>
