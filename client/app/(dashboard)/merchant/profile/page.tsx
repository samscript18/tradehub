            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="flex items-center space-x-3">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    handleFeatureChange('deliveryAvailable', checked as boolean)
                  }
              ...
              <div className="flex items-center space-x-3">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    handleFeatureChange('communityPartner', checked as boolean)
                  }
                  className="border-gray-600 data-[state=checked]:bg-blue-600 data-[state=checked]:border-blue-600 w-5 h-5"
                />
                <Label
                  htmlFor="communityPartner"
                  className="text-white text-sm"
                >
                  Community Partner
                </Label>
        ...
        <div className="px-6 space-y-8 pb-8">
          ...
          <div className="flex items-center justify-between pt-4 border-t border-gray-800">
            <p className="text-sm text-gray-400">
              Last verified: {formData.bankingDetails.lastVerified}
            </p>
