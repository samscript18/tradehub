...
import { Merchant, CreateProductDto, Product } from "../types/types";
...
export const initiateWithdraw = async (data: { amount: string; account_number: string; account_name: string; bank_code: string }) => {
	try {
