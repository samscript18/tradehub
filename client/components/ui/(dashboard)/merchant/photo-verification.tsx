	...
	return (
		<div className="space-y-8 lg:space-y-12">
			...
			<div className="flex items-center gap-4">
				<BackButton />
				<div>
					<h2 className="text-2xl lg:text-3xl font-semibold text-white dark:text-white">Profile Photo</h2>
					<p className="text-gray-600 dark:text-gray-400 text-lg mt-2">Upload a clear photo of yourself</p>
				</div>
			</div>
				...
				{showCamera ? (
					<div className="space-y-6">
						...
						<div className="flex flex-col sm:flex-row gap-3">
							<Button variant="filled" size="medium" onClick={capturePhoto} className="flex-1">
								Capture Photo
							</Button>
							<Button variant="outline" size="medium" onClick={stopCamera} className="flex-1 sm:flex-none">
								Cancel
							</Button>
						</div>
					</div>
					...
					<div className="space-y-6">
						<div className="relative">
							<div className="w-48 h-48 lg:w-56 lg:h-56 mx-auto rounded-full overflow-hidden border-4 border-green-200 dark:border-green-800 shadow-lg">
								<Image
									src={URL.createObjectURL(data.profilePhoto) || '/placeholder.svg'}
									alt="Profile photo"
									width={224}
									height={224}
						...
						<div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-6 border border-green-200 dark:border-green-800 text-center">
							...
							<p className="text-green-700 dark:text-green-400 font-medium">Photo uploaded successfully!</p>
						</div>
					</div>
				) : (
					<div className="space-y-6">
						<div
							...
							<div className="space-y-6">
								...
								<p className="text-sm text-gray-500 dark:text-gray-400">Supported formats: JPG, PNG (Max 5MB)</p>
							</div>
						</div>
					</div>
				)}
			...
			<div className="flex flex-col sm:flex-row justify-between gap-4 pt-8">
				<Button variant="outline" size="medium" onClick={onPrev} className="sm:min-w-32">
					Back
				</Button>
				<Button
					variant="filled"
